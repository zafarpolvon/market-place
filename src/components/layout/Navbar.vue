  ...
  <div class="navbar__back">
    <div class="container mx-auto px-4 xl:px-12 md:px-12">
      <div class="flex justify-between py-2 relative">
        ...
        <div class="flex navbar__text">
          <a href="#"> Продавайте на NovaMarkt </a>
        ...
        <div class="col-span-3">
          <div class="relative search__input">
            <input
              ...
              type="search"
              v-model="searchValue"
              class="py-2 w-full text-sm text-white rounded-md pl-4 pr-12 text-gray-900"
              placeholder="Я ищу"
              autocomplete="off"
            />
            <transition name="fade">
              <search-web :items="entries" v-if="entries.length" />

              <!-- <div 
      v-if="!items.length && isLoading && searchValue.length"
    ...
    >
      Нет данных...
        ...
        <div class="col-span-2">
          <div class="flex navbar__icons">
            ...
            >
              <img
                class="h-6 flex flex-row items-center"
            ...
            >
              <span
                ...
                class="count__navbar1"
                v-text="cartItems.length + 1"
              />
              <span v-else class="count__navbar1">0</span>
              <img
                class="h-5 flex flex-row items-center"
            ...
            >
              ...
              <img
                class="h-7 flex flex-row items-center"
            ...
            <router-link
              ...
              tag="a"
              to="/info"
              class="flex flex-col justify-between navbar__category"
            >
              <li
                class="flex flex-col justify-between navbar__category"
                  ...
                  >
                    <a href="#" class="profile__header">
                      <div class="profile__image">
                        <img
                          src="../../assets/image/carbon_user-avatar-filled-alt.png"
                          alt=""
                        />
                      </div>
                      <div class="profile__title">
                        <h5>{{ user.name || "Нету данных" }}</h5>
                      </div>
                    </a>
      ...
      <div class="menu__mobile">
        <div class="menu__logo">
          <a href="/"
            ><img class="h-8 my-3" src="../../assets/image/logo.png" alt=""
          /></a>
        </div>
...
export default {
  ...
  computed: {
    ...
    cartItems: (vm) => vm.GET_CART_ITEMS,
    user: (vm) => vm.GET_USER,
  },

  watch: {
    searchValue: debounce(async function (query) {
      this.entries = [];
      if (`${query || ""}`.length > 2) {
        this.isLoading = true;
        this.entries = await this.SEARCH({ query });
